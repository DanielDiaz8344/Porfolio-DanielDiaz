...
const Ribbons: React.FC<RibbonsProps> = ({
  ...
  useEffect(() => {
    ...
    const lines: {
      spring: number; friction: number; mouseVelocity: Vec3; mouseOffset: Vec3; points: Vec3[]; polyline: Polyline;
    }[] = [];
    ...
    colors.forEach((color, index) => {
      ...
      const line = {
        spring, friction, mouseVelocity: new Vec3(), mouseOffset,
        points: [] as Vec3[], polyline: {} as Polyline
      };
