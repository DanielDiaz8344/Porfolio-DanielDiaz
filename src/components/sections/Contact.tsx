...
export default function Contact() {
  ...
  return (
    <section id="contact" className="relative py-24 md:py-32 bg-[#0a0a0a] overflow-hidden">
      {/* Ambient glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[min(400px,80vw)] h-[min(400px,80vw)] bg-[#E53935]/[0.05] rounded-full blur-[80px] pointer-events-none" aria-hidden="true" />
