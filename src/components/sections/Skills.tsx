...
const Abbr = memo(function Abbr({ children, color }: { children: string; color: string }) {
  return (
...
const CapCutIcon = memo(function CapCutIcon() {
  return (
...
const NanoBananaIcon = memo(function NanoBananaIcon() {
  return <span className="text-[1.1em] leading-none">🍌</span>;
});
...
const ToolCard = memo(function ToolCard({ tool }: { tool: Tool }) {
  ...
  return (
    <div
      tabIndex={0}
      className="group relative overflow-hidden rounded-xl bg-white/[0.03] backdrop-blur-md border border-white/[0.08] px-4 py-3.5 flex items-center gap-3 transition-all duration-500 hover:bg-white/[0.07] hover:border-white/[0.15] hover:shadow-[0_8px_32px_rgba(229,57,53,0.08)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#E53935]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a]"
    >
